...
class Input
{
    private $constituentName;

    public function setConstituentName($name)
    {
    	$this->constituentName=$name;
    }
    ...
    public function validateConstituentEntry()
    {
       if(empty($this->constituentName))
       {
          return false;
       }
       else
...
class Query
{
    ...
    public function buildQuery($constituent_name)
    {

       $this->query = $this->query."SELECT medicine.name as medicine_name, constituents.name as constituent_name from medicine, constituents where medicine.medicine_id = constituents.medicine_id and constituents.name = :name";
...
{   
    ...
    $input->setConstituentName($_POST['constituent_name']);
	
	if($input->validateConstituentEntry() == false)
	{
         throw new Exception("Please enter Constituent name");
	}
	$name = $input->getConstituentName();
	print "<h1> Search results \n Constituent name: $name </h1>\n";
