...
class Input
{
    ...
    public function validateManufacturerEntry()
    {
...
class Query
{
    ...
    public function buildQuery($manufacturer_name)
    {

       $this->query = $this->query."SELECT medicine.name as medicine_name, manufacturer.manufacturer_name from medicine,manufacturer where manufacturer.manufacturer_id = medicine.manufacturer_id and manufacturer.manufacturer_name = :name";
...
{   
    ...
    $input->setManufacturerName($_POST['manufacturer_name']);
	
	if($input->validateManufacturerEntry() == false)
	{
         throw new Exception("Please enter Manufacturer name");
	}
	$name = $input->getManufacturerName();
